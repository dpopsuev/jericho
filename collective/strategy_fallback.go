...
func (f *Fallback) Select(ctx context.Context, agents []*agent.Solo) []*agent.Solo {
...
func (f *Fallback) Execute(ctx context.Context, prompt string, agents []*agent.Solo) (string, error) {
...
func (f *Fallback) Orchestrate(ctx context.Context, prompt string, agents []*agent.Solo) (string, error) {
